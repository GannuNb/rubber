...
const Footer = () => {
  ...
  <li><Link to ="/Contact"><a >Contact</a></Link></li>
          ...
          <Col xs={12} md={6} lg={4} className="mb-4 text-center text-lg-end"> {/* Centered for small screens, align right on large screens */}
            ...
            <p>Email: Info@vikahecotech.com</p>
            ...
            <div className="text-center text-lg-end"> {/* Center icons on small screens, align right on larger screens */}
              <a href="https://www.facebook.com/people/Vikah-Ecotech/61562484014600/?mibextid=qi2Omg&rdid=DtTaZ8FyfC8gsDCh&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1Mxsd16XWYMsvCyi%2F%3Fmibextid%3Dqi2Omg" className="social-icon me-3" target="_blank" rel="noopener noreferrer">
                <FaFacebook />
              </a>
              <a href="https://x.com/i/flow/login?redirect_after_login=%2Fvikahecotech" className="social-icon me-3" target="_blank" rel="noopener noreferrer">
                <FaTwitter />
              </a>
              <a href="https://www.youtube.com/@vikahecotech" className="social-icon me-3" target="_blank" rel="noopener noreferrer">
                <FaYoutube />
              </a>
              <a href="https://www.instagram.com/vikahecotech/" className="social-icon" target="_blank" rel="noopener noreferrer">
                <FaInstagram />
              </a>
            </div>
          </Col>
